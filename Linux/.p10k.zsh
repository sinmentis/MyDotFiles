# Generated by Powerlevel10k configuration wizard on 2022-07-25 at 16:06 NZST.
...
# lightest, 24h time, slanted separators, slanted heads, slanted tails, 2 lines, solid,
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=131
  ...
  ###########[ timewarrior: timewarrior tracking status (https://timewarrior.net/) ]############
  # Timewarrior color.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_FOREGROUND=165
