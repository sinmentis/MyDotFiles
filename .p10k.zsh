# Generated by Powerlevel10k configuration wizard on 2022-07-25 at 14:06 NZST.
...
# lightest, 24h time, slanted separators, blurred heads, round tails, 2 lines, solid,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=46
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=154
